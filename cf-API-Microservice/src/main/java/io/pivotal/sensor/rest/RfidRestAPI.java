...
public class RfidRestAPI {
	...
	public Iterable<RFIDEvent> getAllRFIDEventsByRfidBetween(@PathVariable String rfid, @PathVariable  @DateTimeFormat(iso = ISO.DATE) Date startDate,@PathVariable  @DateTimeFormat(iso = ISO.DATE) Date endDate) {	
