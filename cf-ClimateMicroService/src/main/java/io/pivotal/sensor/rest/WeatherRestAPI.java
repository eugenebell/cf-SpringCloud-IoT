...
public class WeatherRestAPI {
	...
	public Iterable<Weather> findBySensorID(@PathVariable String sensorID) {
	...
	public Iterable<Weather> findWeatherSensorReadingBetween(@PathVariable String sensorID, @PathVariable  @DateTimeFormat(iso = ISO.DATE) Date startDate, @PathVariable  @DateTimeFormat(iso = ISO.DATE) Date endDate) {
